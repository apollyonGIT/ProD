...
namespace World.Devices.Device_AI
{
    public class NewBasicHook : Device, IAttack, IRecycle, ILoad
    {
        ...
        private const float SPRING_TIGHTNESS_DECAY_ON_SHOOT = 0.1F;
        private const float SPRING_TIGHTNESS_DECAY_WHILE_HOOKED = 0.01F * Config.PHYSICS_TICK_DELTA_TIME;
        private const float SPRING_TIGHTNESS_ADD_BY_ROTATION = 0.0003F;
        private const float SPRING_TIGHTNESS_MIN = 0.5F;
        ...
        {
            get { return _st; }
            set { _st = Mathf.Clamp(value, SPRING_TIGHTNESS_MIN, 1f); }
        }
        ...
        public override void InitData(device_all rc)
        {
            ...
            spring_tightness_01 = SPRING_TIGHTNESS_MIN;
        ...
        public override void tick()
        {
            ...
            switch (m_fsm)
            {
                ...
                case Device_FSM_Hook.Breaking_reeling_in:
                    ...
                    var new_length_limit = Mathf.Max(0f, pos_relative.magnitude - move_speed_reeling_in * spring_tightness_01 * Config.PHYSICS_TICK_DELTA_TIME);
        ...
        private void shoot_hook(Vector2 dir)
        {
            ...
            hook_v = move_speed_shooting * dir.normalized * spring_tightness_01 + WorldContext.instance.caravan_velocity;
        ...
        private void hook_make_dmg(int atk)
        { 
            //BattleContext.instance.ChangeDmg(this, hook_target.hurt(new () { atk = atk }));
            hook_target.hurt(this, new() { atk = atk }, out var dmg_data);
        ...
        private void Fire()
        {
            if (Current_Interval <= 0 && fsm == Device_FSM_Hook.Ready_to_Shoot)
                shoot_hook(bones_direction[BONE_FOR_ROTATION]);
        }
        #endregion
