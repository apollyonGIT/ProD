        ...
        private void modify_variable(string variable_name,int delta)
        {
            switch (variable_name)
            {
                ...
                case "global_atk_add":
                    ...
                    break;
                case "global_critical_rate":
                    BattleContext.instance.global_critical_rate += delta;
                    break;
                case "global_critical_dmg":
                    BattleContext.instance.global_critical_dmg += delta;
                    break;
                ...
                case "melee_atk_add":
                    ...
                    break;
                case "melee_critical_rate":
                    BattleContext.instance.melee_critical_rate += delta;
                    break;
                case "melee_critical_dmg":
                    BattleContext.instance.melee_critical_dmg += delta;
                    break;
                ...
                case "ranged_atk_add":
                    ...
                    break;
                case "ranged_critical_rate":
                    BattleContext.instance.ranged_critical_rate += delta;
                    break;
                case "ranged_critical_dmg":
                    BattleContext.instance.ranged_critical_dmg += delta;
                    break;
