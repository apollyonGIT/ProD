    ...
    public static class CharacterUtility
    {
        ...
        public static CharacterProperty GetProperty(Character c,uint p_id)
        {
            ...
            switch (p.script)
            {
                ...
                case "CP_Metabolism_Fast":
                    return new CP_Metabolism_Fast(c, p);
                case "CP_Metabolism_Slow":
                    return new CP_Metabolism_Slow(c, p);
                case "CP_Metabolism_None":
                    return new CP_Metabolism_None(c, p);
